...
| 4 | Refinement-fidelity eval suite; publish vs-ChatGPT results | Builds on `docs/eval-set.csv` | 🟡 Harness shipped (v10.18, 2026-07-12) — 20-case dataset + offline regression gate (fidelity 1.000 deterministic ceiling) + ChatGPT-baseline scorer. Publishing blocked on founder: run `--live`, record ChatGPT answers per `eval/baselines/chatgpt_refinement.template.json`, publish `eval/out/refinement_fidelity_report.md` |
