...
export function ItineraryDocument({ days, config, expenseBreakdown }: Props) {
  ...
  return (
    <Document title={title} author="WanderPlanner" creator="WanderPlanner">
      <Page size="A4" style={styles.page}>
        {/* Cover */}
        <Text style={styles.brand}>WanderPlanner</Text>
        ...
        <View style={styles.footer} fixed>
          <Text>Generated by WanderPlanner · wanderplanner.app</Text>
